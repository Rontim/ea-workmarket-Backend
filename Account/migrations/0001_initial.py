    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default='user name', max_length=100, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(default='location', max_length=100)),
                ...
                ('role', models.CharField(choices=[('creator', 'creator'), ('freelancer', 'freelancer')], default='Candidate', max_length=20)),
